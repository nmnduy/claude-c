...
#define CLAUDE_C_VERSION_NUMBER 0x000105

// Build timestamp (automatically generated)
#define CLAUDE_C_BUILD_TIMESTAMP "2025-11-11"

// Full version string with build info
#define CLAUDE_C_VERSION_FULL "0.1.5 (built 2025-11-11)"
